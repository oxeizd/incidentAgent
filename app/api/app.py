...
from .openai_compat import mount_openai_compat_endpoint
...
async def lifespan(app: FastAPI) -> AsyncIterator[None]:
    ...
    mount_openai_compat_endpoint(app)
    ...
    async def post_thread_message(
        ...
        async with lock:
            ...
            try:
                ...
                logger.exception("post_thread_message failed")
                raise HTTPException(status_code=500, detail="Не удалось обработать сообщение. Попробуйте ещё раз.")
    ...
    async def message(payload: MessageRequest, request: Request) -> EventSourceResponse:
        ...
        async def event_source():
            ...
            async with lock:
                ...
                async for event in stream_graph_events(    graph,    graph_input,    config,    thread_id=payload.thread_id,    suppress=awaiting,):

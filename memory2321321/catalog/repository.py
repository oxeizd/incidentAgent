...
class EntityCatalogRepository:
    """
    Persistent source of truth для canonical incident entities.

    Fuzzy matching, cache и ambiguity decision не входят в repository:
    это задача EntityCatalogResolver. Repository выполняет только
    атомарные CRUD и bulk upsert операции.
    """

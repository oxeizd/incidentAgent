...
from memory.artifacts.presentations.repository import PresentationRepository
...
class MemoryApplication:
    ...
    instance and call start()/stop() during the application lifespan.
    """
    ...
    async def healthcheck(self) -> dict[str, object]:
        ...
        Does not load the embedding model: model loading belongs to the
        first actual embedding request or an explicit warm-up operation.
        """

...
class SearchResultRepository:
    """
    Хранилище immutable snapshots поисковой выдачи.

    SearchResultRecord хранит порядок и состав выдачи. Domain rows
    гидратируются отдельно во время открытия UI page, поэтому изменение
    incident/assignment не ломает pagination и ranking snapshot-а.
    """
